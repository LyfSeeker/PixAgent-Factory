...
export function Landing() {
  return <main className="noctra-landing">
    ...
    <section className="landing-hero">
      <div className="hero-copy"><p className="landing-kicker"><span>✦</span> OBSERVABLE AI SOFTWARE STUDIO <b>·</b> 2026</p><h1>PIX<br/><em>AGENT</em><br/>FAACTORY</h1><p className="landing-lede">A pixel operations system for directing your coding agents with scoped work, visible evidence, and human approval gates.</p><div className="hero-actions"><Link className="workspace-link" href="/workspace"><span className="button-label">Go to Agent Workspace</span><span className="button-arrow">→</span></Link><a className="text-link" href="#workflow">Explore the system <span>↓</span></a></div></div>
